...
function() {
    ...
    function b(a, b, c) {
        return this.svg = n.select(a).append("svg").attr("width", c ).attr("data-width", c ).attr("class", "datamap").attr("height", b).style("overflow", "hidden"),
    ...
    function e(b) {
        ...
        h.enter().append("path").attr("d", this.path).attr("class",
        function(a) {
    ...
    function f() {
        ...
        var c = this.svg,
        d = this,
        e = this.options.geographyConfig; (e.highlightOnHover || e.popupOnHover) && c.selectAll(".datamaps-subunit").on("mouseover",
        function(f) {
            var g = n.select(this),
    ...
    function i(b, c, d) {
        ...
        for (var g = 0; g < c.length; g++) c[g] = l(c[g], c[g].options),
        delete c[g].options;
        ...
        h.enter().append("svg:path").attr("class", "datamaps-arc").style("stroke-linecap", "round").style("stroke",
        function(b) {
    ...
    function j(a, b) {
        ...
        this.svg.selectAll(".datamaps-subunit").attr("data-foo",
        function(e) {
            var f = c.path.centroid(e),
            g = 7.5,
            h = 5; ["FL", "KY", "MI"].indexOf(e.id) > -1 && (g = -2.5),
            "NY" === e.id && (g = -1),
            "MI" === e.id && (h = 18),
            "LA" === e.id && (g = 13);
            var i, j;
    ...
    function k(b, c, d) {
        ...
        j.enter().append("svg:circle").attr("class", "datamaps-bubble").attr("cx",
        function(a) {
            var b;
        ...
        j.transition().duration(400).attr("r",
        function(b) {
            return a(b.radius, d.radius, b)
        }).transition().duration(0).attr("data-info",
        function(a) {
            return JSON.stringify(a)
        }),
    ...
    m.prototype.draw = function() {
        function a(a) {
            b.options.dataUrl && n[b.options.dataType](b.options.dataUrl,
            function(a) {
                if ("csv" === b.options.dataType && a && a.slice) {
                    for (var c = {},
                    d = 0; d < a.length; d++) c[a[d].id] = a[d];
                    a = c
                }
        ...
        c.geographyConfig.dataUrl ? n.json(c.geographyConfig.dataUrl,
        function(c, d) {
    ...
    m.prototype.updateChoropleth = function(a, b) {
        var c = this.svg;
        b && b.reset === !0 && c.selectAll(".datamaps-subunit").attr("data-info",
        function() {
            return "{}"
    ...
    m.prototype.addPlugin = function(a, b) {
        ...
        "undefined" == typeof m.prototype[a] && (m.prototype[a] = function(d, e, f, g) {
            ...
            e = l(e || {},
            c.options[a + "Config"]),
            !g && this.options[a + "Layer"] ? (h = this.options[a + "Layer"], e = e || this.options[a + "Options"]) : (h = this.addLayer(a), this.options[a + "Layer"] = h, this.options[a + "Options"] = e),
            b.apply(this, [h, d, e]),
            f && f(h)
        })
    },
    "object" == typeof exports ? (n = require("d3"), o = require("topojson"), module.exports = m) : "function" == typeof define && define.amd ? define("datamaps", ["require", "d3", "topojson"],
    function(a) {
        return n = a("d3"),
        o = a("topojson"),
        m
